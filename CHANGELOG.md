...
- Replaced `universal_html` with conditionally imported `web` package for token storage
- Split token storage into platform-specific implementations for Wasm-compatible web builds

## [1.0.4] - 2026-06-24

### Changed

- Updated `database_bridge` dependency to `^1.0.4`
- Switched `DioBridgeTokenManager` import to `database_bridge_core.dart` entry point

## [1.0.3] - 2026-03-11

### Changed

- Replaced `web` package with `universal_html` package
